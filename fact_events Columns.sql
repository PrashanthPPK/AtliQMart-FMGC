...
UPDATE fact_events SET discount_price = base_price * 0.25 WHERE promo_type = '25% OFF';
UPDATE fact_events SET discount_price = base_price * 0.33 WHERE promo_type = '33% OFF';
